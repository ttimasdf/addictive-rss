...
Welcome to `addictive-rss` contributor's guide.
...
If you experience bugs or general issues with `addictive-rss`, please have a look
...
You can help improve `addictive-rss` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`addictive-rss` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `addictive-rss`'s files. While this mechanism can
...
```
conda create -n addictive-rss python=3 six virtualenv pytest pytest-cov
conda activate addictive-rss
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/addictive-rss.git
   cd addictive-rss
   ```
...
5. Install [pre-commit]:
   ...
   `addictive-rss` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/addictive-rss
[issue tracker]: https://github.com/<USERNAME>/addictive-rss/issues
